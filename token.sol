...
contract LiquidityGeneratorToken is Context, IERC20, Ownable {
    ...
    constructor (address tokenOwner,string memory tokenName, string memory tokenSymbol,uint8 decimal, uint256 amountOfTokenWei,uint8 setTaxFee, uint8 setLiqFee, uint256 _maxTaxFee, uint256 _maxLiqFee, uint256 _minMxTxPer, address  _router) public{
        _name = tokenName;
        _symbol = tokenSymbol;
        _decimals = decimal;
